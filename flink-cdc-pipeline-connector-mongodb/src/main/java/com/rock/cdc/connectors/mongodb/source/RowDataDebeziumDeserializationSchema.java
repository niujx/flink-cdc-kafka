...
//import java.util.*;
//
//public class RowDataDebeziumDeserializationSchema  implements DebeziumDeserializationSchema<Event> {
//
//    protected final TimeZone localTimeZone;
//    protected static final String DATE_FORMAT_PATTERN = "yyyy-MM-dd HH:mm:ss";
//
//    public RowDataDebeziumDeserializationSchema(ZoneId timeZone) {
...
//            List<Object> pkValues = Lists.newArrayList(keyDocument.get(MongoDBEnvelope.ID_FIELD).asObjectId().getValue().toString());
//            Map<String, Object> columnData = extractColumnData(fullDocument);
